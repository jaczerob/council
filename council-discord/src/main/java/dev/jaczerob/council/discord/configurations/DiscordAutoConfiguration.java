...
public class DiscordAutoConfiguration {
    ...
    public JDA jda(
        ...
        slashCommands.forEach(slashCommandRegistry::register);
        ...
        messageContextCommands.forEach(messageContextCommandRegistry::register);
        ...
        userContextCommands.forEach(userContextCommandRegistry::register);
    ...
    private @NonNull List<CommandData> getUserContextCommandData(
        ...
        userContextCommands.forEach(userContextCommand -> {
    ...
    private @NonNull List<CommandData> getMessageContextCommandData(
        ...
        messageContextCommands.forEach(messageContextCommand -> {
